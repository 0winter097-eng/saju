...
const r=spawnSync(process.execPath,['--test','--test-reporter=tap','tests/engine.test.mjs','tests/readings.test.mjs','tests/annual.test.mjs','tests/expanded.test.mjs'],{encoding:'utf8'});
...
const sources=['dist/engine.js','dist/terms.js','dist/vendor/korean-lunar-calendar.js','tests/fixtures.json','tests/engine.test.mjs','dist/readings.js','tests/readings.test.mjs','dist/annual.js','tests/annual.test.mjs','dist/reading-rules.js','dist/time-input.js','dist/app.js','dist/index.html','dist/styles.css','tests/expanded.test.mjs'];
...
writeFileSync('dist/verification.json',JSON.stringify({date:new Date().toISOString().slice(0,10),passed,total,hashes,groups:[
 ...
 {name:'확장 해석·시간대 입력',description:'원국 구성·기간 배경·지지 관계·대운 변경 및 문장 근거를 검증하고, 13개 시간대의 1440분 전체 범위와 시간 경계·서머타임을 확인했습니다.'},
